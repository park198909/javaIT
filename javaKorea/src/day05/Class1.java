...
public class Class1 {								// 클래스(자바는 클래스 기반의 언어)
...
class MyClass1{
	...
	int function1() {
		// int n = 1;
		System.out.println("메서드1 사용");	// 클래스 내부의 함수를 메서드라고 부른다.(사실상 자바의 함수는 모두 매서드)
		return 1;							// 함수 내 return이 없으면 에러가 발생한다.
	}
