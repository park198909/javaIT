...
// 잘하는 사람 : 설계
class MyClass9{
	// 접근권한제어자 : 변수에는 private, 메서드에는 public
	private int num1, num2;			// 변수에는 정보가 저장된다. 보안
	
	// get : 바깥(다른 클래스)에서 사용하게 할 때
	public int getNum1() {
		return num1;
	}
	// set : 바깥(다른 클래스)에서 값을 받아올 때
	...
	// 접근권한 제어자 public / private/ protected/drfault
	// public : 모두 사용 가능 
	// protected : 같은 패키지 + 상속에서 사용 가능
	// (default) : 같은 패키지에서만 사용 가능
	// private : 같은 클래스이 경우만 사용가능
